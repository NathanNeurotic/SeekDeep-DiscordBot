...
'@ | Set-Content .\patch_stabilized_dispatch.py -Encoding UTF8

& $pyExe .\patch_stabilized_dispatch.py

node --check .\index.js
.\.venv\Scripts\python.exe -m py_compile .\local_ai_server.py

Write-Host ""
Write-Host "[SeekDeep] Stabilized dispatcher patch complete. Restart with launcher option 8." -ForegroundColor Green
