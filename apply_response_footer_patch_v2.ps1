...
'@ | Set-Content .\patch_response_footer_v2.py -Encoding UTF8

.\.venv\Scripts\python.exe .\patch_response_footer_v2.py

node --check .\index.js
.\.venv\Scripts\python.exe -m py_compile .\local_ai_server.py

Write-Host ""
Write-Host "[SeekDeep] Response footer v2 patch complete. Restart with launcher option 8." -ForegroundColor Green
