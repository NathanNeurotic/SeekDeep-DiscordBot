...
'@ | Set-Content .\patch_image_prompt_refinement.py -Encoding UTF8

& $pyExe .\patch_image_prompt_refinement.py

node --check .\index.js
.\.venv\Scripts\python.exe -m py_compile .\local_ai_server.py

Write-Host ""
Write-Host "[SeekDeep] Image prompt refinement patch complete. Restart with launcher option 8." -ForegroundColor Green
