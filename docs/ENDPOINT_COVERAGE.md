...
| GET | `/bot/vision-mode` | token | bot-bridge.js | yes |
| POST | `/bot/vision-mode` | token | bot-bridge.js | yes |
| GET | `/bot/web-search` | token | bot-bridge.js | yes |
| POST | `/bot/web-search` | token | bot-bridge.js | yes |
