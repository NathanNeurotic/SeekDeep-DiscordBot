...
async function seekdeepHandleContextMenuGenerateImage(interaction, targetMessage) {
  ...
  try {
    ...
    return seekdeepSendImageWithButtons(proxy, basePrompt, width, height, seed, modeOptions);`;
    ...
    return seekdeepSendImageWithButtons(proxy, finalPrompt, width, height, seed, modeOptions);`;
