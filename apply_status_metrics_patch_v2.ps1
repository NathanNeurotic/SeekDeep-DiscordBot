...
'@ | Set-Content .\patch_status_metrics_v2.py -Encoding UTF8

& $pyExe .\patch_status_metrics_v2.py

node --check .\index.js
.\.venv\Scripts\python.exe -m py_compile .\local_ai_server.py

Write-Host ""
Write-Host "[SeekDeep] Status metrics v2 patch complete. Restart with launcher option 8." -ForegroundColor Green
