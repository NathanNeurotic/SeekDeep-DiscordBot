...
'@ | Set-Content .\patch_batch1_server_utility.py -Encoding UTF8

& $pyExe .\patch_batch1_server_utility.py

node --check .\index.js
.\.venv\Scripts\python.exe -m py_compile .\local_ai_server.py

Write-Host ""
Write-Host "[SeekDeep] Batch 1 server utility patch complete. Restart with launcher option 8." -ForegroundColor Green
