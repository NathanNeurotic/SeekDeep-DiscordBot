...
'@ | Set-Content .\patch_early_image_route_hotfix.py -Encoding UTF8

& $pyExe .\patch_early_image_route_hotfix.py

node --check .\index.js
.\.venv\Scripts\python.exe -m py_compile .\local_ai_server.py

Write-Host ""
Write-Host "[SeekDeep] Early image route hotfix complete. Restart with launcher option 8." -ForegroundColor Green
