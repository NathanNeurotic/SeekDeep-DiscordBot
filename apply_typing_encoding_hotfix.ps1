...
'@ | Set-Content .\patch_typing_encoding_hotfix.py -Encoding UTF8

& $pyExe .\patch_typing_encoding_hotfix.py

node --check .\index.js
.\.venv\Scripts\python.exe -m py_compile .\local_ai_server.py

Write-Host ""
Write-Host "[SeekDeep] Typing indicator / encoding hotfix complete. Restart with launcher option 8." -ForegroundColor Green
