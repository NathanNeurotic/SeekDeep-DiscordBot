...
stage('js', () => {
  ...
  const targets = ['index.js', 'smoke_test.mjs', 'scripts/preflight.mjs', 'gui/nav.js', 'gui/events.js', 'gui/version.js', 'gui/playground.js', 'gui/stats.js', 'gui/ml-deps.js', 'gui/model-install.js', 'gui/notify.js', 'gui/updater.js'];
