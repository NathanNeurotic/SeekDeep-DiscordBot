...
'@ | Set-Content .\patch_batch2_image_queue.py -Encoding UTF8

& $pyExe .\patch_batch2_image_queue.py

node --check .\index.js
.\.venv\Scripts\python.exe -m py_compile .\local_ai_server.py

Write-Host ""
Write-Host "[SeekDeep] Batch 2 image queue patch complete. Restart with launcher option 8." -ForegroundColor Green
