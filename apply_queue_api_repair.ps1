...
'@ | Set-Content .\patch_queue_api_repair.py -Encoding UTF8

& $pyExe .\patch_queue_api_repair.py

node --check .\index.js
.\.venv\Scripts\python.exe -m py_compile .\local_ai_server.py

Write-Host ""
Write-Host "[SeekDeep] Queue API repair complete. Restart with launcher option 8." -ForegroundColor Green
