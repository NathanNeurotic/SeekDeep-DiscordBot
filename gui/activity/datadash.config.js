...
window.DATADASH = {
  ...
  LEVELS: [
    ...
    { name: "BOOT · DATA STREAM", sub: "spooling up — ease in", threshold: 0, speed: 760,
      ...
      shape: { tower:"rect", rampFrac:0.50, wallStepFrac:0, towerMin:0.06, towerMax:0.12, pinchAmt:0.10, featMin:10, featMax:18, obsChance:0.40, obsDoubleChance:0.00,
        weights:{ open:0.50, floorTower:0.16, ceilTower:0.16, pinch:0.04, ramp:0.14 } } },
    { name: "KB · DATA STREAM", sub: "kilobyte channel", threshold: 1e3, speed: 920,
      ...
      shape: { tower:"chamfer", rampFrac:0.45, wallStepFrac:0, towerMin:0.07, towerMax:0.14, pinchAmt:0.12, featMin:9, featMax:16, obsChance:0.52, obsDoubleChance:0.04,
        weights:{ open:0.40, floorTower:0.19, ceilTower:0.19, pinch:0.07, ramp:0.15 } } },
    { name: "MB · DATA RIVER", sub: "megabyte flow", threshold: 1e6, speed: 1120,
      ...
      shape: { tower:"trapezoid", rampFrac:0.38, wallStepFrac:0.04, towerMin:0.08, towerMax:0.16, pinchAmt:0.15, featMin:7, featMax:14, obsChance:0.66, obsDoubleChance:0.10,
        weights:{ open:0.30, floorTower:0.22, ceilTower:0.22, pinch:0.11, ramp:0.15 } } },
    // --- teal @ 250MB (colour shift; speed keeps climbing) ---
    { name: "MB · DATA SURGE", sub: "quarter-gig — current rising", threshold: 2.5e8, speed: 1360,
      ...
      shape: { tower:"stepped", rampFrac:0.28, wallStepFrac:0.05, towerMin:0.09, towerMax:0.175, pinchAmt:0.17, featMin:6, featMax:12, obsChance:0.78, obsDoubleChance:0.16,
        weights:{ open:0.22, floorTower:0.25, ceilTower:0.25, pinch:0.13, ramp:0.15 } } },
    // --- green @ GB (the original speed) ---
    { name: "GB · DATA TORRENT", sub: "gigabyte zone — full speed", threshold: 1e9, speed: 1720,
      ...
      shape: { tower:"oval", rampFrac:0.18, wallStepFrac:0, towerMin:0.10, towerMax:0.185, pinchAmt:0.18, featMin:5, featMax:10, obsChance:0.85, obsDoubleChance:0.20,
        weights:{ open:0.15, floorTower:0.29, ceilTower:0.29, pinch:0.15, ramp:0.12 } } },
    // --- red @ TB (fastest, brutal) ---
    { name: "TB · DATA OVERLOAD", sub: "terabyte zone — maximum velocity", threshold: 1e12, speed: 2080,
      ...
      shape: { tower:"spike", rampFrac:0.22, wallStepFrac:0.04, towerMin:0.11, towerMax:0.185, pinchAmt:0.18, featMin:4, featMax:8, obsChance:0.92, obsDoubleChance:0.30,
