...
(function () {
  ...
  var PAGES = [
    ...
    { id: 'operations',   title: 'Operations',      path: 'operations.html',   group: 'manage', glyph: '⛑', meta: 'restart · flush · reload · doctor · self-update · kill', live: true, navigable: true, gateFlag: null, palette: true, more: false },
