...
const SEEKDEEP_BASE = (function() {
  ...
  // ===== Logs viewer =====
  // Single owner now lives in app.page5.js (SSE /logs/stream + /logs/tail poll
  // fallback + dedup cursor + level/source/search filters + header truth-up).
  // The duplicate SSE viewer that used to live here was removed in v10.38.223 —
  // it double-wired #logs-wrap (double render + double pause/clear on the same
  // pane). See app.page5.js "Task 5 · logs viewer (single consolidated owner)".
