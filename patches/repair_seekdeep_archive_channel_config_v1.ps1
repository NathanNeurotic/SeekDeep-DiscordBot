...
$BackupPath = Join-Path $BackupsDir "index.js.before-archive-channel-config-v1-$Stamp.bak"
Copy-Item $IndexPath $BackupPath -Force
Write-Host "Backup created: $BackupPath"

$PatchJsPath = Join-Path $PatchesDir "apply_archive_channel_config_v1_$Stamp.cjs"
@'
const fs = require('fs');
...
console.log('Patched archive channel configuration flow successfully.');
