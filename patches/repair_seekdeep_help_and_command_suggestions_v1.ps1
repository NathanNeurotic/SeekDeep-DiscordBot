...
$BackupPath = Join-Path $BackupsDir "index.js.before-help-command-suggestions-v1-$Stamp.bak"
$PatchJsPath = Join-Path $PatchesDir "apply_help_command_suggestions_v1_$Stamp.cjs"
