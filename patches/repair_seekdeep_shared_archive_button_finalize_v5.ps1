...
$IndexBackupPath = Join-Path $BackupsDir "index.js.before-shared-archive-button-finalize-v5-$Stamp.bak"
$PatchJsPath = Join-Path $PatchesDir "apply_shared_archive_button_finalize_v5_$Stamp.cjs"
