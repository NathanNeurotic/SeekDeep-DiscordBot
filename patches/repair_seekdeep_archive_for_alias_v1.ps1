...
if (-not (Test-Path $IndexPath)) {
  throw "index.js not found at $IndexPath. Run this from the project root."
}
...
$BackupPath = Join-Path $BackupsDir "index.js.before-archive-for-alias-v1-$Stamp.bak"
Copy-Item $IndexPath $BackupPath -Force
Write-Host "Backup created: $BackupPath"

$PatchJsPath = Join-Path $PatchesDir "apply_archive_for_alias_v1_$Stamp.cjs"
@'
const fs = require('fs');
